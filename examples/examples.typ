  ...
  columns(2)[
    #showybox(
      ...
      frame: (
        ...
        break-style: (
          upper-break: line(length: 100%, stroke: (dash: "dashed", paint: blue.darken(50%))),
          lower-break: line(length: 100%, stroke: (dash: "dashed", paint: blue.darken(50%))),
        ),
      ),
      breakable: true,
    )[
